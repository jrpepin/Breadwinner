*****************************************************************************
*  The goal for this script is to create annual measures of earnings 
*****************************************************************************
...
*******************************************************************************
* indicators for whether observations in each wave (w) 
*******************************************************************************

forvalues w=1/15 {
gen in`w'=0
gen nmpearn`w'=0 // personal earnings is not missing in wave w
gen nmhearn`w'=0 // household earnings is not missing in wave w
gen nmupearn`w'=0 // personal earnings is not missing with no allocated data in wave w
gen nmuhearn`w'=0 // household earnings is not missing with no allocated data in wave w
gen anyhhinc`w'=0 // household had any income
...
* by multiplying by 4 if we have three observations (4*3=12), by 6 if we have 2
* observations, and by 12 if we have 1.
*******************************************************************************
...
gen ueverbw60=.
 ...
 forvalues y=1/4 {
   ...
   gen ubecbw50`y'=0 if !missing(uyearbw50`y') & ueverbw50!=1
   ...
   gen ubecbw60`y'=0 if !missing(uyearbw60`y') & ueverbw60!=1
...
* describe sample
	 ...
	 drop all_p3 tagid 
display "After dropping missing years, we still have `allindividuals3' people."
